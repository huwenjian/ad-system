...
public class ReflectUtil {
     ...
     */
    private static final Map<Class<?>, SoftReference<Map<String, Field>>> RESOLVED_CLASS_CACHE = new ConcurrentHashMap<>();
    ...
    public static Map<String, Field> resolveClassFieldMap(final Class<?> sourceClass) {
        ...
        SoftReference<Map<String, Field>> softReference = RESOLVED_CLASS_CACHE.get(sourceClass);
        ...
        if (softReference == null || softReference.get() == null) {
            ...
            synchronized (sourceClass) {
                ...
                softReference = RESOLVED_CLASS_CACHE.get(sourceClass);
                ...
                if (softReference == null || softReference.get() == null) {
                    ...
                    */
                     ...
                     */
                    RESOLVED_CLASS_CACHE.put(sourceClass, softReference);
     ...
     * 忽略掉对象里面的某些字段
     */
    private static void filterByFieldName(Map<String, Field> fieldMap, String... ignoreFieldNames) {

        //需要忽略的对象字段
        List<String> ignoreNames = ReflectUtil.resolveArrayToList(ignoreFieldNames);
     ...
     * 忽略掉非空的字段或者空的字段
     */
    private static void filterByFieldValue(Object object, Map<String, Field> fieldMap, boolean filterNullAble) {
